.. _pyhdtoolkit-cpymadtools:

Cpymadtools
===========

The ``cpymadtools`` subpackage is a collection of utilities to conveniently handle MAD-X_ simulations through the ``cpymad`` library.
...
.. automodule:: pyhdtoolkit.cpymadtools.tune
   :members:

.. automodule:: pyhdtoolkit.cpymadtools.twiss
   :members:

.. automodule:: pyhdtoolkit.cpymadtools.utils
   :members:
