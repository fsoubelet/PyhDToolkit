...
def test_amplitude_detuning(tmp_path, _ampdet_tfs_path, _matched_base_lattice):
...
def test_rdts(tmp_path, _rdts_tfs_path):
    ...
    match_tunes_and_chromaticities(madx, None, "CAS3", 6.335, 6.29, 100, 100, varied_knobs=["kqf", "kqd", "ksf", "ksd"])
...
def test_single_particle_ptc_track(_matched_base_lattice, obs_points):
    madx = _matched_base_lattice
