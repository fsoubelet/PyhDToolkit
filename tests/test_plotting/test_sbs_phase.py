...
class TestPhaseSbsPlotting:
    @pytest.mark.mpl_image_compare(tolerance=20, style="seaborn-pastel", savefig_kwargs={"dpi": 200})
    def test_plot_one_beam(self, sbs_phasex, sbs_phasey, sbs_model_b2):
    ...
    @pytest.mark.mpl_image_compare(tolerance=20, style="seaborn-pastel", savefig_kwargs={"dpi": 200})
    def test_plot_both_beams(self, sbs_phasex, sbs_phasey, sbs_model_b2):
    ...
    def test_plot_phase_segment_raises_on_wrong_plane(self, wrongplane, sbs_phasex, sbs_model_b2):
