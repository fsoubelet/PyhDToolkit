...
class ACDipoleGrid:
    ...
    def _check_input_sanity(self) -> None:
        """
        Makes sure there are no duplicates in the provided sigma values, because that will mess up a long time after
    ...
    def track_forced_oscillations_for_plane(self, kick_plane: str = None) -> None:
        ...
        Args:
            kick_plane: the name of the plane on which to apply a kick, either 'horizontal' or 'vertical'.
    ...
    def track_free_oscillations_for_plane(self, kick_plane: str = None) -> None:
        ...
        Args:
            kick_plane: the name of the plane on which to apply an offset, either 'horizontal' or 'vertical'.
...
def _rename_madx_outputs(kick_in_sigma: str, outputdata_dir: Path, plane: str) -> None:
    ...
    Args:
        kick_in_sigma: the AC dipole kick value (in sigma) for which you ran your simulation.
        outputdata_dir: a `pathlib.Path` object with the folder in which to store all successive `Outputdata`'s
        location.
        plane: the plane on which ac dipole provided the kick, should be `x` or `y`.
